...
namespace KYPCenterManagement.Controllers
{
    ...
    public class CentersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CenterName,CenterAddress")] Center center)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CenterName,CenterAddress")] Center center)
        {
            if (ModelState.IsValid)
            {
